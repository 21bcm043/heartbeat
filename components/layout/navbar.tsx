...
export default function Navbar() {
  ...
  return (
    <header className="select-none">
      <nav className="mx-auto justify-between md:flex md:items-center md:px-8 lg:max-w-7xl">
        <div>
          <div className="flex items-center justify-between py-3 md:block md:py-5">
            <div className="flex items-center">
              <Link target="_blank" href="https://www.psgcas.ac.in/index.html" onClick={handleClick} className="flex items-center space-x-2 gap-2">
                <Image src={"/psgcas.jpg"} alt={"Logo"} width={32} height={32} />
                <h1 className="text-xl font-bold duration-200 lg:hover:scale-[1.05] hover:text-amber-400">
                  {siteConfig.name}
                </h1>
              </Link>
            </div>
